        ...
        <div class="row">
          <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
            ...
            <p class="text-muted small mb-4 mb-lg-0">
              &copy; 2017 &sdot; Ready2Party Ltd. All Rights Reserved.
              Courtesy to <a class="text-muted" href="https://startbootstrap.com/template-overviews/landing-page/">StartBootstrap</a> for the template.
            </p>
          </div>

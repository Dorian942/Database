...
class UserManager {
    ...
    public function persistUser(User $user) {
        try {
        	echo $user->getEmail();
            $req = $this->db->prepare('INSERT INTO client (Nom, Prenom, Adresse, Login, MotDePasse, confirm_token) /*active, confirm_token, is_admin*/
                                    VALUES (:nom, :prenom, :adresse, :email, :psw, :confirm_token )');
